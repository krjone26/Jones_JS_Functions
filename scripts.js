...
function logNumber(num){
    return num; // console won't get logged because return is beforehand (needs to be at the end)
    console.log(num);
}
logNumber(5);
logNumber("Hello");
console.log(logNumber(9)); // undefined because no return statement
// console.log(logNumber); logs actual function

function logString(string){
    return string;
}
console.log(logString("Hey!"));


let mySum = addTwoNums(2, 3);
console.log(mySum); // you must return a value if you want to use it outside of the function
